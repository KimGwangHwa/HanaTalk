...
class HanaInternalTextView: UITextView {
    ...
    override init(frame: CGRect, textContainer: NSTextContainer?) {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(HanaInternalTextView.textDidChangeNotification(_ :)), name: NSNotification.Name.UITextViewTextDidChange, object: self)
    }
